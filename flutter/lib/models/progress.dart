...
class EpubLocator extends ReadingLocator {
  ...
  const EpubLocator(this.href,{this.cfi,this.progression,this.bookProgression,this.spineIndex,this.spineCount});
  @override Map<String,dynamic> toJson()=>{'kind':'epub','href':href,if(cfi!=null)'cfi':cfi,if(progression!=null)'progression':progression,if(bookProgression!=null)'bookProgression':bookProgression,if(spineIndex!=null)'spineIndex':spineIndex,if(spineCount!=null)'spineCount':spineCount};
}
